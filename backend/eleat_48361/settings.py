"""
Django settings for eleat_48361 project.
...
WSGI_APPLICATION = 'eleat_48361.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "eleat_48361 API",
    "DESCRIPTION": "API documentation for eleat_48361 App",
    "VERSION": "v1",
}
